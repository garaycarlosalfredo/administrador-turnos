...
import com.administrador.turnos.dto.TorreDto;
import com.administrador.turnos.entity.Torre;
import com.administrador.turnos.service.TorreService;
...
public class TorreController {
    ...
    public ResponseEntity<?> creaTorre(@RequestBody TorreDto torreDto){
        ...
        if((torreDto.getNombreTorre().isBlank()))
